...
import 'package:assignment/screens/home_screen/components/row_widget.dart';
import 'package:assignment/screens/home_screen/components/search_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Drinks> usersList = [];
  List<Drinks> tempUsersList = [];
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return RowWidget.customerRow(
                          ...
                          image: usersList[index].strDrinkThumb?? '',
                        productName: usersList[index].strDrink?? '',
                          titleName: usersList[index].strGlass?? '');
                    },
                  ),
                ),
              ]);
